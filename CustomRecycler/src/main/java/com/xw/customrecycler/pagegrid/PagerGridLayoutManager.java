...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager 
    ...
    public PagerGridLayoutManager(@IntRange(from = 1, to = 100) int rows,
                                  ...
                                  @PagerGridLayoutManager.OrientationType int orientation) {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        Log.i("info","Item onLayoutChildren");
        Log.i("info","Item onLayoutChildren isPreLayout = " + state.isPreLayout());
        Log.i("info","Item onLayoutChildren isMeasuring = " + state.isMeasuring());
        Log.e("info","Item onLayoutChildren state = " + state);
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        Log.i("info","mOffsetX = " + mOffsetX);
        Log.i("info","mOffsetY = " + mOffsetY);
        ...
        Log.e("info","startPos = " + startPos);
        Log.e("info","stopPos = " + stopPos);
        ...
        Log.e("info","child count = " + getChildCount());
    }
    ...
    public void onScrollStateChanged(int state) {
        Log.i("info","onScrollStateChanged = " + state);
        mScrollState = state;
    ...
    private Rect getItemFrameByPosition(int pos) {
        ...
        if (null == rect) {
            ...
            // 状态输出，用于调试
            Log.i("info","pagePos = " + pagePos);
            Log.i("info","行 = " + row);
            Log.i("info","列 = " + col);

            Log.i("info","offsetX = " + offsetX);
            Log.i("info","offsetY = " + offsetY);
    ...
    private int getPageIndexByOffset() {
        ...
        Log.i("info","getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
    ...
    int findNextPageFirstPos() {
        ...
        Log.e("info","computeScrollVectorForPosition next = " + page);
    ...
    int findPrePageFirstPos() {
        ...
        int page = mLastPageIndex;
        page--;
        Log.e("info","computeScrollVectorForPosition pre = " + page);
        if (page < 0) {
            page = 0;
        }
        Log.e("info","computeScrollVectorForPosition pre = " + page);
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        Log.e("info","setPageIndex = " + pageIndex + ":" + isScrolling);
    ...
    public void scrollToPage(int pageIndex) {
        ...
        Log.e("info","mTargetOffsetXBy = " + mTargetOffsetXBy);
        Log.e("info","mTargetOffsetYBy = " + mTargetOffsetYBy);
