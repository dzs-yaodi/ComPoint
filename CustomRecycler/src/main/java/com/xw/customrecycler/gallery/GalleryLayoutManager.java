...
public class GalleryLayoutManager extends RecyclerView.LayoutManager {
    ...
    public GalleryLayoutManager(boolean isFlat, boolean isGreyItem,
...
//            cm.setSaturation(0.9f);
    ...
    /**
     * 获取中间位置
     * <p>Note:该方法主要用于{@link RecyclerGallery#getChildDrawingOrder(int, int)}判断中间位置
    ...
    public static class Builder {
        ...
        public GalleryLayoutManager build() {
            return new GalleryLayoutManager(isFlat, isGreyItem,
